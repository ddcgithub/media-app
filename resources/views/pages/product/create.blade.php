    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('product.store') }}">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Product Create</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">Create your media product.</p>
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-4 flex justify-center text-sm leading-6 text-gray-600">
                                    <label for="file-upload"
                                        ...
                                        <input id="file-upload" name="image" accept=".jpg,.jpeg,.png,.gif,.bmp,.webp"
