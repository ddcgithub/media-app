<nav x-data="{ open: false }" class="navbar bg-base-100 mb-12 px-4 shadow-xl rounded-box border justify-between">
            ...
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button
                        ...
                        <div>สวัสดี, {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</div>
                ...
                <x-slot name="content">
                    ...
                    {{-- <x-dropdown-link :href="route('admin.product.create')">
                        {{ __('Product create') }}
                    </x-dropdown-link> --}}
